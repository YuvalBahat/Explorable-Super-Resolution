...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        # self.CopyFromRandom_button = QtWidgets.QPushButton(icon=icon_copyRandZ, parent=MainWindow)
        # self.CopyFromRandom_button.setObjectName("actionCopyFromRandom")
        # self.CopyFromRandom_button.setEnabled(False)
        # self.CopyFromRandom_button.setToolTip('Copy displayed random region to Z')

        Define_Push_Button(button_name='Copy2Random', tooltip='Copy region from Z to random images')
        # self.Copy2Random_button = QtWidgets.QPushButton(MainWindow)
        # icon_copyDefault2RandZ = QIcon()
        # icon_copyDefault2RandZ.addPixmap(QPixmap("icons/default2randoms.png"), QIcon.Normal, QIcon.Off)
        # self.Copy2Random_button.setIcon(icon_copyDefault2RandZ)
        # self.Copy2Random_button.setObjectName("actionCopy2Random")
        # self.Copy2Random_button.setToolTip('Copy region from Z to random images')

        Define_Push_Button(button_name='indicatePeriodicity', tooltip='Set desired periodicity', checkable=True)
        # self.indicatePeriodicity_button = QtWidgets.QPushButton(self.widget)
        # self.indicatePeriodicity_button.setSizePolicy(ReturnSizePolicy(QtWidgets.QSizePolicy.Fixed, self.indicatePeriodicity_button.sizePolicy().hasHeightForWidth()))
        # self.indicatePeriodicity_button.setMinimumSize(QtCore.QSize(30, 30))
        # self.indicatePeriodicity_button.setMaximumSize(QtCore.QSize(30, 30))
        # self.indicatePeriodicity_button.setText("")
        # icon_indicate_periodicity = QIcon()
        # icon_indicate_periodicity.addPixmap(QPixmap("icons/indicate_periodicity.png"), QIcon.Normal, QIcon.Off)
        # self.indicatePeriodicity_button.setIcon(icon_indicate_periodicity)
        # self.indicatePeriodicity_button.setCheckable(True)
        # self.indicatePeriodicity_button.setObjectName("indicatePeriodicity_button")
        # self.indicatePeriodicity_button.setToolTip('Set desired periodicity')
        ...
        # self.selectrect_button = QtWidgets.QPushButton(self.widget)
        # self.selectrect_button.setSizePolicy(ReturnSizePolicy(QtWidgets.QSizePolicy.Fixed,self.selectrect_button.sizePolicy().hasHeightForWidth()))
        # self.selectrect_button.setMinimumSize(QtCore.QSize(30, 30))
        # self.selectrect_button.setMaximumSize(QtCore.QSize(30, 30))
        # self.selectrect_button.setText("")
        # self.selectrect_button.setToolTip('Rectangle selection')
        # icon2 = QIcon()
        # icon2.addPixmap(QPixmap("icons/selection.png"), QIcon.Normal, QIcon.Off)
        # self.selectrect_button.setIcon(icon2)
        # self.selectrect_button.setCheckable(True)
        # self.selectrect_button.setObjectName("selectrect_button")
        ...
        # self.selectpoly_button = QtWidgets.QPushButton(self.widget)
        # sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        # sizePolicy.setHorizontalStretch(0)
        # sizePolicy.setVerticalStretch(0)
        # sizePolicy.setHeightForWidth(self.selectpoly_button.sizePolicy().hasHeightForWidth())
        # self.selectpoly_button.setSizePolicy(sizePolicy)
        # self.selectpoly_button.setMinimumSize(QtCore.QSize(30, 30))
        # self.selectpoly_button.setMaximumSize(QtCore.QSize(30, 30))
        # self.selectpoly_button.setText("")
        # self.selectpoly_button.setToolTip('Polygon selection')
        # icon6 = QIcon()
        # icon6.addPixmap(QPixmap("icons/selection-poly.png"), QIcon.Normal, QIcon.Off)
        # self.selectpoly_button.setIcon(icon6)
        # self.selectpoly_button.setCheckable(True)
        # self.selectpoly_button.setObjectName("selectpoly_button")
        ...
        # self.unselect_button = QtWidgets.QPushButton(self.widget)
        # self.unselect_button.setSizePolicy(ReturnSizePolicy(QtWidgets.QSizePolicy.Fixed,self.unselect_button.sizePolicy().hasHeightForWidth()))
        # self.unselect_button.setMinimumSize(QtCore.QSize(30, 30))
        # self.unselect_button.setMaximumSize(QtCore.QSize(30, 30))
        # self.unselect_button.setText("")
        # icon6_0 = QIcon()
        # icon6_0.addPixmap(QPixmap("icons/unselect.png"), QIcon.Normal, QIcon.Off)
        # self.unselect_button.setIcon(icon6_0)
        # self.unselect_button.setCheckable(False)
        # self.unselect_button.setObjectName("unselect_button")
        # self.unselect_button.setToolTip('De-select')
        ...
        # self.invertSelection_button = QtWidgets.QPushButton(self.widget)
        # self.invertSelection_button.setSizePolicy(ReturnSizePolicy(QtWidgets.QSizePolicy.Fixed,self.invertSelection_button.sizePolicy().hasHeightForWidth()))
        # self.invertSelection_button.setMinimumSize(QtCore.QSize(30, 30))
        # self.invertSelection_button.setMaximumSize(QtCore.QSize(30, 30))
        # self.invertSelection_button.setText("")
        # icon6_0 = QIcon()
        # icon6_0.addPixmap(QPixmap("icons/invertSelection.png"), QIcon.Normal, QIcon.Off)
        # self.invertSelection_button.setIcon(icon6_0)
        # self.invertSelection_button.setCheckable(False)
        # self.invertSelection_button.setObjectName("invertSelection_button")
        # self.invertSelection_button.setToolTip('Invert selection')
        ...
        # self.uniformZ_button = QtWidgets.QPushButton(self.widget)
        # self.uniformZ_button.setSizePolicy(ReturnSizePolicy(QtWidgets.QSizePolicy.Fixed,self.uniformZ_button.sizePolicy().hasHeightForWidth()))
        # self.uniformZ_button.setMinimumSize(QtCore.QSize(30, 30))
        # self.uniformZ_button.setMaximumSize(QtCore.QSize(30, 30))
        # self.uniformZ_button.setText("")
        # icon6_0 = QIcon()
        # icon6_0.addPixmap(QPixmap("icons/uniform_Z.png"), QIcon.Normal, QIcon.Off)
        # self.uniformZ_button.setIcon(icon6_0)
        # self.uniformZ_button.setCheckable(False)
        # self.uniformZ_button.setObjectName("uniformZ_button")
        # self.uniformZ_button.setToolTip('Spatially uniform Z')
        ...
        # self.desiredExternalAppearanceMode_button = QtWidgets.QPushButton(self.widget)
        # self.desiredExternalAppearanceMode_button.setSizePolicy(ReturnSizePolicy(QtWidgets.QSizePolicy.Fixed,self.desiredExternalAppearanceMode_button.sizePolicy().hasHeightForWidth()))
        # self.desiredExternalAppearanceMode_button.setMinimumSize(QtCore.QSize(30, 30))
        # self.desiredExternalAppearanceMode_button.setMaximumSize(QtCore.QSize(30, 30))
        # self.desiredExternalAppearanceMode_button.setText("")
        # icon4 = QIcon()
        # icon4.addPixmap(QPixmap("icons/image_hist.png"), QIcon.Normal, QIcon.Off)
        # self.desiredExternalAppearanceMode_button.setIcon(icon4)
        # self.desiredExternalAppearanceMode_button.setCheckable(True)
        # self.desiredExternalAppearanceMode_button.setObjectName("desiredImageHistMode_button")
        # self.desiredExternalAppearanceMode_button.setToolTip('Select external desired region')
        ...
        # self.desiredAppearanceMode_button = QtWidgets.QPushButton(self.widget)
        # self.desiredAppearanceMode_button.setSizePolicy(ReturnSizePolicy(QtWidgets.QSizePolicy.Fixed,self.desiredAppearanceMode_button.sizePolicy().hasHeightForWidth()))
        # self.desiredAppearanceMode_button.setMinimumSize(QtCore.QSize(30, 30))
        # self.desiredAppearanceMode_button.setMaximumSize(QtCore.QSize(30, 30))
        # self.desiredAppearanceMode_button.setText("")
        # icon4 = QIcon()
        # icon4.addPixmap(QPixmap("icons/hist.png"), QIcon.Normal, QIcon.Off)
        # self.desiredAppearanceMode_button.setIcon(icon4)
        # self.desiredAppearanceMode_button.setCheckable(True)
        # self.desiredAppearanceMode_button.setObjectName("desiredHistMode_button")
        # self.desiredAppearanceMode_button.setToolTip('Select desired region')
        ...
        # self.Zdisplay_button = QtWidgets.QPushButton(self.widget)
        # self.Zdisplay_button.setSizePolicy(ReturnSizePolicy(QtWidgets.QSizePolicy.Fixed,self.Zdisplay_button.sizePolicy().hasHeightForWidth()))
        # self.Zdisplay_button.setMinimumSize(QtCore.QSize(30, 30))
        # self.Zdisplay_button.setMaximumSize(QtCore.QSize(30, 30))
        # self.Zdisplay_button.setText("")
        # icon_Zdisplay = QIcon()
        # icon_Zdisplay.addPixmap(QPixmap("icons/Z_letter.jpg"), QIcon.Normal, QIcon.Off)
        # self.Zdisplay_button.setIcon(icon_Zdisplay)
        # self.Zdisplay_button.setCheckable(True)
        # self.Zdisplay_button.setObjectName("Zdisplay_button")
        # self.Zdisplay_button.setToolTip('Toggle Z display')
        ...
        # icon_Undo_scribble = QIcon()
        # icon_Undo_scribble.addPixmap(QPixmap("icons/undo_scribble.png"), QIcon.Normal, QIcon.Off)
        ...
        # icon_Redo_scribble = QIcon()
        # icon_Redo_scribble.addPixmap(QPixmap("icons/redo_scribble.png"), QIcon.Normal, QIcon.Off)
        ...
        for button_num,button in enumerate(['left','right','up','down']):
            ...
            # cur_button.setText("")
            # cur_icon = QIcon()
            # cur_icon.addPixmap(QPixmap("icons/translate_%s.png"%(button)), QIcon.Normal, QIcon.Off)
        ...
        for button_num,button in enumerate(['narrower','wider','taller','shorter']):
            ...
            # cur_button.setText("")
            # cur_icon = QIcon()
            # cur_icon.addPixmap(QPixmap("icons/make_%s.png"%(button)), QIcon.Normal, QIcon.Off)
            # cur_button.setIcon(cur_icon)
            # cur_button.setCheckable(False)
            # cur_button.setObjectName(button+'_imprinting_button')
            # cur_button.setEnabled(False)
        ...
        # icon_UndoZ = QIcon()
        # icon_UndoZ.addPixmap(QPixmap("icons/undo_Z.png"), QIcon.Normal, QIcon.Off)
        ...
        # icon_redoZ = QIcon()
        # icon_redoZ.addPixmap(QPixmap("icons/redo_Z.png"), QIcon.Normal, QIcon.Off)
        ...
        # icon5 = QIcon()
        # icon5.addPixmap(QPixmap("icons/auto_temperature.png"), QIcon.Normal, QIcon.Off)
        ...
        # icon_brush = QIcon()
        # icon_brush.addPixmap(QPixmap("icons/paint-brush.png"), QIcon.Normal, QIcon.Off)
        ...
        # self.polygon_button.setMinimumSize(QtCore.QSize(30, 30))
        # self.polygon_button.setMaximumSize(QtCore.QSize(30, 30))
        ...
        # self.ellipse_button.setIcon(icon13)
        ...
        # self.gridLayout.addWidget(self.ellipse_button, 7, 0, 1, 1)
