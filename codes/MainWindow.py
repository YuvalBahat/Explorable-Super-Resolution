...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        MainWindow.addToolBar(QtCore.Qt.LeftToolBarArea if MainWindow.display_zoom_factor>1 else QtCore.Qt.BottomToolBarArea, self.ZToolbar2)
        ...
        icon_im_input_transparent_mask = QtGui.QIcon()
        icon_im_input_transparent_mask.addPixmap(QtGui.QPixmap("images/image_input_noDC.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.im_input_transparent_maskButton = QtWidgets.QPushButton(parent=self.Scribble_Toolbar,icon=icon_im_input_transparent_mask)
        self.im_input_transparent_maskButton.setCheckable(True)
        self.im_input_transparent_maskButton.setObjectName("im_input_transparent_maskButton")
        self.im_input_transparent_maskButton.setEnabled(False)
        ...
        self.patchOptimizationBehaviorModeButton = QtWidgets.QPushButton(parent=self.ZToolbar2,icon=patch_opt_behavior_icon)
        self.patchOptimizationBehaviorModeButton.setCheckable(True)
        self.patchOptimizationBehaviorModeButton.setObjectName("patchOptimizationBehaviorModeButton")
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "Editable SR"+(' (x%d)'%(self.display_zoom_factor) if self.display_zoom_factor>1 else '')))
