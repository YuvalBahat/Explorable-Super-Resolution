...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        # adding a null button:
        # self.rand_ZButton = QtWidgets.QPushButton(self.widget)
        # self.rand_ZButton.setMinimumSize(QtCore.QSize(30, 30))
        # self.rand_ZButton.setMaximumSize(QtCore.QSize(30, 30))
        # self.rand_ZButton.setText("Rand Z")
        # icon_randZ = QtGui.QIcon()
        # icon_randZ.addPixmap(QtGui.QPixmap("images/layer-shape.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        # self.rand_ZButton.setIcon(icon_randZ)
        # self.rand_ZButton.setCheckable(True)
        # self.rand_ZButton.setObjectName("rand_ZButton")
        # self.gridLayout.addWidget(self.rand_ZButton, 6, 0, 1, 1)
        ...
        self.ZToolbar.setIconSize(QtCore.QSize(16, 160))
        self.ZToolbar.setObjectName("ZToolbar")
        self.ZToolbar.setOrientation(QtCore.Qt.Horizontal)
        MainWindow.addToolBar(QtCore.Qt.LeftToolBarArea, self.ZToolbar)
        # Z_grid = QtWidgets.QGridLayout()
        # Z_widget = QtWidgets.QWidget()
        # Z_widget.setLayout(Z_grid)
        # MainWindow.addToolBar(Z_widget)
        # Z_grid.addWidget()
        ...
        self.fileToolbar.addAction(self.actionProcessRandZ)
        # self.ZToolbar.addWidget(self.sliderZ0)
        # self.ZToolbar.addAction(self.actionReProcess)
